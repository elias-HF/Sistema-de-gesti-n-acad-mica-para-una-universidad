...
public class FrmInscripcion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Sistema Académico - Gestión de Inscripciones");
        setResizable(false);
        ...
        lblFecha.setText("Fecha Inscripción:");
        ...
        cmbCurso.setFont(new java.awt.Font("Segoe UI", 0, 12));
        cmbCurso.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione..." }));
        cmbCurso.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(200, 200, 200)));

        txtFecha.setFont(new java.awt.Font("Segoe UI", 0, 12));
        txtFecha.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(200, 200, 200)));
        ...
        tblInscripciones.setFont(new java.awt.Font("Segoe UI", 0, 11));
        tblInscripciones.setModel(new DefaultTableModel(
            new Object [][] {},
            new String [] { "ID", "Estudiante", "Curso", "Fecha" }
        ));
        tblInscripciones.setRowHeight(25);
            ...
            jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(lblCurso)
                        .addGap(5, 5, 5)
                        .addComponent(cmbCurso, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(15, 15, 15)
                        .addComponent(lblFecha)
                        .addGap(5, 5, 5)
